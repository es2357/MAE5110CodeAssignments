...
## Pendulum simulation
_Before_ running the code: read through the pendulum simulation in `assignment_0/assignment_0.py`, and predict what you expect to happen. Then run it.
